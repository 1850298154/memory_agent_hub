...
推荐的投资书单分为四类：入门选《生命周期投资法》和《持续买入》；进阶选股看《战胜华尔街》；期权策略读《Options as a Strategic Investment》；大跌防御参考《The Second Leg Down》。每本都针对不同投资阶段的需求。
Leto 因靠投资赚到 3000 万、从字节辞职而出圈。在近期的直播中，他分享了自己的投资书单，从入门配置到选股、期权和大跌防守都覆盖到了！

## 介绍了5种AI推理加速核心技术：
1)静态批处理(凑够一批统一算，但慢请求拖累整体)；2)动态批处理(设时间窗，到点或满额即处理)；3)持续批处理(完成请求退出，新请求实时补入)；4)Chunked Prefill(长预填充拆小块，穿插处理)；5)PD分离(计算密集的Prefill与访存密集的Decode分开调度)。这些技术共同提升了AI服务的吞吐量和响应速度。
...
①精准验证  
通过"数据科学机械外骨骼"系统，将大模型输出与确定性验证器实时比对，达成99.99%工业级准确率  

②轻量化部署  
本地小模型即可运行处理器优化引擎，直连数据仓库，兼顾成本控制与隐私安全  

③行业真相  
创始人揭露大型实验室回避幻觉问题的本质——用户反复修正行为构成其核心盈利模式  

④跨域应用  
已在金融风控、医疗诊断等精度敏感场景验证，可扩展至会计审计等专业领域  

1 优先选用含确定性验证层的AI工具处理关键业务  
2 在采购AI服务时明确要求准确率验证机制与数据主权条款  
3 建立人工复核节点，特别针对财务、医疗等高风险决策环节  
4 关注本地化AI部署方案，平衡精度需求与基础设施投入  

精准不在模型体量，而在敢于戳破行业利益泡沫的勇气  

相关报道：  
http://mp.weixin.qq.com/s?__biz=MzAxNTU3NTM1OA==&mid=2650979631&idx=1&sn=c3e440bfc6f388a2d4f613409efae8af  
http://mp.weixin.qq.com/s?__biz=MzYzNzcyMzkwNw==&mid=2247484738&idx=2&sn=67e96f0ef1e7efd6737621f39fce65...
...
论文《Discovering Expert-Level Nash Equilibrium Algorithms with Large Language Models》已于2026年6月12日正式发表在Nature Communications，比视频中提到的6月4日晚几天。原文链接：https://doi.org/10.1038/s41467-026-74003-1。北大新闻稿和智源社区有详细解读可供参考。
...
## 最佳学术skill
最崩溃的是，你不是没努力。
文献搜了三天，论文读了40篇，笔记整理了一大堆，但最后就是收不成一个能写进论文的核心论点。
章节写到一半才发现，后面的论证和最开始的研究问题已经跑偏了。
投稿前想找人帮你审一遍，可同事没时间，导师也没空，整篇论文几乎是在没人认真把关的情况下被你硬推到了最后。
等内容终于写完，APA格式、LaTeX排版、参考文献规范，又开始继续消耗你的时间。
而这个skill： academic-research-skills，它能帮你收敛问题、整理文献、检查逻辑、规范格式，甚至模拟5个独立审稿人进行同行评审。
对于正在写论文、做研究的人来说，它是一个能陪你走完全程的AI研究伙伴。


gitHub路径是 Imbad0202/academic-research-skills，完整地址：https://github.com/Imbad0202/academic-research-skills
...
模仿董宇辉卖榴莲的话术：'卖的不是水果，是儿时乡愁和中年辛酸。他长在南国风雨中，用坚硬外壳守护柔软内心，像极了城市打拼的你。90块钱买不到回家车票，却能买一口藏在果肉里的故乡。'

罗永浩风格的话术核心是：先戳痛点再立人设。"我先把丑话撂在前面——这榴莲闻着冲还带刺，长相歪瓜裂枣。别指望光鲜亮丽，那些香气扑鼻的全是科技与狠活！市面上吹'极品贡果'的，要么催熟打药，要么修图美颜，溢价翻几倍纯割韭菜。我这颗自然长熟，没膨大没掺假，丑是真丑但好吃也是真顶。你剥开尝一口，不好吃直接骂我，我低头认。成本42我偏卖50，只赚8块明码标价。爱买不买，买了就知道——带刺的榴莲不需要解释。"


雷军式卖榴莲话术：  
"先说个扎心事实——你们吃的榴莲都拉低了味觉标准。为找天花板级榴莲，我们团队横跨五大产区，飞行29999公里，比赤道还长2公里。最终在马来西亚发现：外壳带刺、果肉金黄！连夜召开高管会议，用43200秒深度研判，重新定义标准——108个刺身+装甲级防刺结构，果径19cm黄金五房，甜度54°超茅台1度。为攻克香甜平衡难题，把实验室建在榴莲河中央！采用自研零度保鲜，5000公里冷链只补一次冰，碾压99%竞品。300元内最好吃，今天首发价49.9元，顺丰包邮！但百年老树仅产2000颗，抢完等一年——为吃货发烧，这就是人生必入的核弹级榴莲。"



## 港科大开源的Awesome Data Agents项目详细解析了数据代理从L0到L5的进化路径，涵盖各层级自主性与角色定义。
项目地址：https://github.com/HKUSTDial/awesome-data-agents，目前568星。


## Composer 2是Cursor团队基于Kimi 2.5微调的专业代码大模型，通过持续预训练和强化学习显著提升真实开发任务表现。
技术报告地址：https://arxiv.org/abs/2603.24477


## 介绍了13个科研工具，分为两条路线：
1）多种工具分工协作，包括paper-framework（框架图）、nature-figure（实验图）、Research-Paper-Writing（正文写作）等；2）全流程技能包academic-research-skills。核心工具官网：zotero.org（文献管理）、obsidian.md（知识库）、figdraw.com（科研绘图）。
...
## 一个前缀把任何网页变成LLM友好的Markdown  

你有没有想用AI处理网页内容，但网页里全是HTML标签、广告、导航栏，AI根本读不懂？复制粘贴还要手动清理，费时费力？Jina AI开源的Reader只需在URL前加个前缀 `https://r.jina.ai/`，就能把任何网页转成干净的Markdown格式，1万+星标。它不是简单的HTML转Markdown，而是智能内容提取器——自动去除广告、导航、侧边栏，只保留核心内容，完美适配LLM输入。具体来说，它做了这些事：1）一个URL前缀搞定，无需安装任何工具；2）智能识别正文内容，过滤无关元素；3）输出标准Markdown，可以直接喂给GPT、Claude；4）支持批量处理，API调用。特别适合做RAG应用、AI网页摘要、内容爬取、知识库构建——那些需要把网页内容喂给AI的场景。这不只是"格式转换工具"，而是把"网页喂AI=手动清理"升级到"网页喂AI=一键转换"。

## 主题：Nexus-7可视化驾驶舱：AI Agent浏览器操作全流程展示

1. 关键词：驾驶舱功能
核心总结：霓虹光标拖尾、点击爆开波纹、focus框扫描高亮，实现动态视觉反馈

2. 关键词：思考流呈现
核心总结：实时打字操作配合右侧Python命令与数据流同步显示，直观展现Agent思维过程

3. 关键词：卡点跳进度
核心总结：侧边栏滑动浏览网页时，思考流自动同步更新当前内容，实现精准控制

4. 关键词：一键复述
核心总结：右键调出三栏摘要，支持0.5-2倍调速播放，可直接复制关键信息

1. 探索开源项目：访问GitHub搜索"Nexus-7 browser agent"获取代码
2. 实践驾驶舱功能：尝试0.5-2倍调速查看Agent操作全流程
3. 验证技术指标：测试WebArena-Lite性能（71% vs 商业版64%）
4. 集成应用场景：将驾驶舱接入现有Agent runtime系统
...
支持批量导入PDF/网页/视频，一键生成播客、PPTX、思维导图等多格式内容。GitHub地址：https://github.com/teng-lin/notebooklm-py

## 阿里开源的Page Agent工具，这是一个纯前端实现的网页AI操作员。
它的核心特点是只需在网页中添加一行代码，就能让用户通过自然语言指令控制网页操作，无需安装插件或配置后端。Page Agent与browser-use等工具有本质区别：它是页面内嵌组件，专为网站开发者设计，操作范围限于当前页面。该工具已在GitHub获得18k+星标，具备智能DOM理解、零后端部署、安全可控等特性，主要应用于智能客服(可直接帮用户操作而非仅指导)、表单自动填写、产品教学演示和无障碍支持等场景。其优势包括数据本地化安全、适配国产大模型、国内网络直连，minzipped体积仅30.8KiB，MIT开源许可。
...
1. 流程革新 翻译→自查→重写→润色四步流水线消除机械感

2. 场景适配 3种模式+5种风格覆盖技术文档到文学作品

3. 智能质检 自动修复6类欧化中文问题提升可读性

4. 专业保障 100+术语表确保全书术语一致性
...
程序员小陈面对英文技术文档，用翠猫翻译后团队误以为是中文原版，终于明白什么叫"像母语者亲笔所写"。

下载地址：https://github.com/Cuimao777/cuimao-translator



翠猫翻译的GitHub地址是：https://github.com/Cuimao777/cuimao-translator

## InsForge：AI原生后端开发平台重塑编码效率

① 平台定位  
开源一体化后端平台，专为AI编码代理设计，实现全栈应用端到端交付

② 核心功能  
集成数据库、身份验证、存储、计算及AI网关五大模块，提供标准化API接口

③ 技术架构  
支持MCP服务与CLI+技能双交互模式，具备结构化可扩展数据库与实时数据同步能力

④ 开发体验  
可视化管理界面降低门槛，边缘函数部署无需服务器运维，网站一键发布

⑤ 生态建设  
GitHub获9.8k stars，获YCombinator支持，已形成65+开发者贡献社区

1 开发者可访问官网注册体验，快速搭建含用户系统的全功能应用原型

2 在GitHub搜索InsForge项目，通过star参与开源生态，获取最新功能迭代

3 学习官方文档掌握MCP连接方法，将现有AI编码工具链接入后端服务体系

4 尝试用Python示例项目实践机器学习场景，验证存储与计算模块协同能力

5 加入Discord开发者社区，获取实战案例与技术支持，共建AI原生开发标准

当代码不再区分前后端，开发者才能真正聚焦创造本身。https://insforge.dev

InsForge开源项目GitHub地址是：https://github.com/InsForge/InsForge
...
项目地址：https://github.com/yanhua-ai/fireworks-tech-graph
...
#知识管理 #AI知识库 #Obsidian #Kaparthy #AI工具 #openAI #笔记方法
## 圆桌Skill深度解析：三层认知价值
...
- **YAML Frontmatter（如 `--- ... ---`）**Obsidian 可以识别每条 Memory 最上方的 YAML 区块，便于后续做属性查询和自动化管理。
- **Markdown 标准语法**memory-network-builder 的内容均为标准 Markdown 格式，Obsidian 100% 支持。
- **双中括号链接 `[[xxx]]` （Wiki Link）**Obsidian 的核心功能之一。
