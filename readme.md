...
- [1. 介绍 LLM、RAG、Agent、Memory、Retrieval、KG 等相关技术的融合](#1-介绍-llmragagentmemoryretrievalkg-等相关技术的融合)
  ...
  - [1.4. coding skill 集合](#14-coding-skill-集合)
  - [1.5. skill.empjs.dev](#15-skillempjsdev)
  - [1.6. skill沙盘集合](#16-skill沙盘集合)
  - [1.7. ralv.ai  /  RVA.ai。](#17-ralvai----rvaai)
  - [1.8. agentic 训练](#18-agentic-训练)
  - [1.9. Manus context summary](#19-manus-context-summary)
  - [1.10. agent memory paper github collection](#110-agent-memory-paper-github-collection)
  - [1.11. agent skill](#111-agent-skill)
  - [1.12. 25年最后总结-大模型手把手及相关开源社区](#112-25年最后总结-大模型手把手及相关开源社区)
  - [1.13. Manus是一款在人工智能领域具有突破性意义的通用AI智能体产品，其“厉害”之处主要体现在以下几个方面：](#113-manus是一款在人工智能领域具有突破性意义的通用ai智能体产品其厉害之处主要体现在以下几个方面)
  - [1.14. DeepAnalyze：自主数据科学中的代理大型语言模型](#114-deepanalyze自主数据科学中的代理大型语言模型)
  - [1.15. LLM在游戏中应用的综述 https://arxiv.org/pdf/2402.18659](#115-llm在游戏中应用的综述-httpsarxivorgpdf240218659)
  - [1.16. “AgentGuide” from adongwanai](#116-agentguide-from-adongwanai)
  - [1.17. 智能体记忆的综述论文《Memory in the Age of AI Agents: A Survey》](#117-智能体记忆的综述论文memory-in-the-age-of-ai-agents-a-survey)
  - [1.18. 2025年11月13截止之前的memory 方案汇总对比](#118-2025年11月13截止之前的memory-方案汇总对比)
  - [1.19. obsidian 做个人 memory](#119-obsidian-做个人-memory)
      - [1.19.0.1. 支持哪些特殊语法？](#11901-支持哪些特殊语法)
      - [1.19.0.2. 如何形成知识图谱？](#11902-如何形成知识图谱)
      - [1.19.0.3. 具体例子说明](#11903-具体例子说明)
  - [1.20. 读论文+github 神器 deepwiki](#120-读论文github-神器-deepwiki)
  - [1.21. verl](#121-verl)
  - [1.22. pageindex](#122-pageindex)
  - [1.23. PostgreSQL == 多合一数据库：用插件替代专用数据库](#123-postgresql--多合一数据库用插件替代专用数据库)
    - [1.23.1. 官网](#1231-官网)
    - [1.23.2. 完整对应清单](#1232-完整对应清单)
    - [1.23.3. 关键插件详解（生产级选型）](#1233-关键插件详解生产级选型)
      - [1.23.3.1. 替代 InfluxDB（时序数据库）](#12331-替代-influxdb时序数据库)
      - [1.23.3.2. 替代 Milvus（向量数据库）](#12332-替代-milvus向量数据库)
      - [1.23.3.3. 替代 Neo4j（图数据库）+ pgRouting（地理路由）](#12333-替代-neo4j图数据库-pgrouting地理路由)
      - [1.23.3.4. 替代 Redis（缓存/高性能读写）](#12334-替代-redis缓存高性能读写)
      - [1.23.3.5. 替代 Elasticsearch（全文检索/搜索引擎）](#12335-替代-elasticsearch全文检索搜索引擎)
      - [1.23.3.6. 替代 MongoDB（文档数据库）](#12336-替代-mongodb文档数据库)
    - [1.23.4. 补充说明](#1234-补充说明)
  - [1.24. agent memory方向主要有2个：](#124-agent-memory方向主要有2个)
  - [1.25. 长记忆开源方案update](#125-长记忆开源方案update)
  - [1.26. Improving Language Agents through BREW](#126-improving-language-agents-through-brew)
  - [1.27. llm各种框架和论文，4000+⭐](#127-llm各种框架和论文4000)
  - [1.28. agent evolver](#128-agent-evolver)
  - [1.29. 微软 agent](#129-微软-agent)
  - [1.30. 谷歌新研究定义"充分上下文"：](#130-谷歌新研究定义充分上下文)
  - [1.31. EverMemOS](#131-evermemos)
  - [1.32. MCP 生态链接](#132-mcp-生态链接)
  - [1.33. 之后是2025年11月13之前汇总](#133-之后是2025年11月13之前汇总)
  - [1.34. 综述](#134-综述)
  - [1.35. context-labs / aella-data-explorer 1亿篇论文组成知识图谱KG](#135-context-labs--aella-data-explorer-1亿篇论文组成知识图谱kg)
  - [1.36. multi ai agent game](#136-multi-ai-agent-game)
  - [1.37. langchain 中间件](#137-langchain-中间件)
  - [1.38. todolist middleware](#138-todolist-middleware)
  - [1.39. 舆情分析](#139-舆情分析)
  - [1.40. LightMem：像人脑一样高效的记忆系统](#140-lightmem像人脑一样高效的记忆系统)
  - [1.41. llm训练](#141-llm训练)
  - [1.42. Prop RAG](#142-prop-rag)
  - [1.43. 基于多模态信息抽取的菜品知识图谱构建](#143-基于多模态信息抽取的菜品知识图谱构建)
  - [1.44. ragflow 已经支持 知识图谱](#144-ragflow-已经支持-知识图谱)
  - [1.45. flashrag](#145-flashrag)
  - [1.46. LightRAG](#146-lightrag)
  - [1.47. llm agent 综述](#147-llm-agent-综述)
  - [1.48. 谷歌 vs 微软 deepresearch](#148-谷歌-vs-微软-deepresearch)
  - [1.49. Reasoning with Sampling: Your Base Model is Smarter Than You Think](#149-reasoning-with-sampling-your-base-model-is-smarter-than-you-think)
  - [1.50. Agentic RAG新范式！天大\&小红书提出DecEx-RAG，剪枝搜索扩展提速6倍](#150-agentic-rag新范式天大小红书提出decex-rag剪枝搜索扩展提速6倍)
  - [1.51. 日报神器，记录你的一天 Dayflow](#151-日报神器记录你的一天-dayflow)
  - [1.52. 可信AI Agent相关论文(DPO)](#152-可信ai-agent相关论文dpo)
  - [1.53. Graph-Base Agent基于任务图的Agent框架](#153-graph-base-agent基于任务图的agent框架)
  - [1.54. A-Mem: Agentic Memory for LLM Agents](#154-a-mem-agentic-memory-for-llm-agents)
  - [1.55. logic rag](#155-logic-rag)
  - [1.56. LightMem](#156-lightmem)
  - [1.57. langchain graphrag](#157-langchain-graphrag)
  - [1.58. G-memory, Arcmemo, reasoning bank](#158-g-memory-arcmemo-reasoning-bank)
  - [1.59. embedding model 天梯](#159-embedding-model-天梯)
  - [1.60. MonkeyOCR](#160-monkeyocr)
  - [1.61. GitHub代码检索](#161-github代码检索)
  - [1.62. 视频转文字](#162-视频转文字)
  - [1.63. 音视频2文本](#163-音视频2文本)
  - [1.64. 爬虫数据采集圣器](#164-爬虫数据采集圣器)
  - [1.65. ai伴侣](#165-ai伴侣)
  - [1.66. metaGPT](#166-metagpt)
  - [1.67. unsloth](#167-unsloth)
  - [1.68. ai 知识库](#168-ai-知识库)
  - [1.69. 高质量rag](#169-高质量rag)
  - [1.70. ai混合搜索 meili](#170-ai混合搜索-meili)
  - [1.71. mem 推移学习，自我改进](#171-mem-推移学习自我改进)
  - [1.72. 腾讯 tree graphrag （2025年9月）](#172-腾讯-tree-graphrag-2025年9月)
  - [1.73. Graphiti vs GraphRAG 对比](#173-graphiti-vs-graphrag-对比)
  - [1.74. 自己用milvus+neo4j实现graphrag](#174-自己用milvusneo4j实现graphrag)
  - [1.75. 微软 graphRAG](#175-微软-graphrag)
  - [1.76. awesome-ai-memory 汇聚memory相关项目](#176-awesome-ai-memory-汇聚memory相关项目)
  - [1.77. es agent](#177-es-agent)
  - [1.78. MINE Context](#178-mine-context)
  - [1.79. 拼好rag](#179-拼好rag)
  - [1.80. mem0 2025年9月27日持续更新github](#180-mem0-2025年9月27日持续更新github)
  - [1.81. 蚂蚁 KAG](#181-蚂蚁-kag)
  - [1.82. 如何基于语义相似性分割文本](#182-如何基于语义相似性分割文本)
  - [1.83. 各种向量数据库对比](#183-各种向量数据库对比)
  - [1.84. 基于hnswlib的向量索引(2年前更新)](#184-基于hnswlib的向量索引2年前更新)
  - [1.85. stream vq 生成式召回](#185-stream-vq-生成式召回)
  - [1.86. ai学术搜索](#186-ai学术搜索)
  - [1.87. nlp etc.](#187-nlp-etc)
  - [1.88. 知识图谱 - 北京大学大数据分析与应用技术国家工程实验室成员，  包括各种知识图谱抽取+检索，neo4j+MongoDB等](#188-知识图谱---北京大学大数据分析与应用技术国家工程实验室成员--包括各种知识图谱抽取检索neo4jmongodb等)
  - [1.89. 唐国梁Tommy : rag + llm + es](#189-唐国梁tommy--rag--llm--es)
  - [1.90. 长文本提取结构化信息](#190-长文本提取结构化信息)
  - [1.91. 非结构化转结构化，用于微调等](#191-非结构化转结构化用于微调等)
  - [1.92. MongoDB + ES 向量存储 + 文本分割器SpacyTextSplitter （24年6月11日）](#192-mongodb--es-向量存储--文本分割器spacytextsplitter-24年6月11日)
  - [1.93. ai coding](#193-ai-coding)
...
## 1.10. agent memory paper github collection
...
## 1.13. Manus是一款在人工智能领域具有突破性意义的通用AI智能体产品，其“厉害”之处主要体现在以下几个方面：
...
## 1.14. DeepAnalyze：自主数据科学中的代理大型语言模型
[DeepAnalyze](https://github.com/DataClasse/deepanalyze)

## 1.15. LLM在游戏中应用的综述 https://arxiv.org/pdf/2402.18659
...
## 1.16. “AgentGuide” from adongwanai
...
## 1.17. 智能体记忆的综述论文《Memory in the Age of AI Agents: A Survey》
...
## 1.18. 2025年11月13截止之前的memory 方案汇总对比
- **AI Memory 项目完整对照表**
- 一、🔥开源记忆框架推荐
  - 1 MemOS
    - 团队：记忆张量 + 上海交大等
...
## 1.23. PostgreSQL == 多合一数据库：用插件替代专用数据库
### 1.23.1. 官网
...
#### 1.23.3.5. 替代 Elasticsearch（全文检索/搜索引擎）
...
## 1.26. Improving Language Agents through BREW
...
## 1.33. 之后是2025年11月13之前汇总

## 1.34. 综述
《Agentic Retrieval-Augmented Generation: A Survey on Agentic RAG》

## 1.35. context-labs / aella-data-explorer 1亿篇论文组成知识图谱KG
...
## 1.48. 谷歌 vs 微软 deepresearch
 https://mp.weixin.qq.com/s/e_1dGQRLfc_fGAZrQEsLVw
## 1.49. Reasoning with Sampling: Your Base Model is Smarter Than You Think
...
## 1.50. Agentic RAG新范式！天大&小红书提出DecEx-RAG，剪枝搜索扩展提速6倍

## 1.51. 日报神器，记录你的一天 Dayflow
项目地址是
 https://github.com/JerryZLiu/Dayflow

，展示了这个开源日报工具

##  1.52. 可信AI Agent相关论文(DPO)
...
## 1.53. Graph-Base Agent基于任务图的Agent框架
...
## 1.54. A-Mem: Agentic Memory for LLM Agents
...
## 1.58. G-memory, Arcmemo, reasoning bank
三篇论文


## 1.59. embedding model 天梯
...
## 1.72. 腾讯 tree graphrag （2025年9月）
https://mp.weixin.qq.com/s/Ddf3rpdJP8P_L5yaPnBFBA

## 1.73. Graphiti vs GraphRAG 对比
...
## 1.74. 自己用milvus+neo4j实现graphrag
...
## 1.76. awesome-ai-memory 汇聚memory相关项目
...
## 1.80. mem0 2025年9月27日持续更新github
基于graph+rag的mem0
...
## 1.84. 基于hnswlib的向量索引(2年前更新)
https://github.com/nmslib/hnswlib

## 1.85. stream vq 生成式召回
...
## 1.88. 知识图谱 - 北京大学大数据分析与应用技术国家工程实验室成员，  包括各种知识图谱抽取+检索，neo4j+MongoDB等
https://liuhuanyong.github.io/

## 1.89. 唐国梁Tommy : rag + llm + es
...
## 1.92. MongoDB + ES 向量存储 + 文本分割器SpacyTextSplitter （24年6月11日）
