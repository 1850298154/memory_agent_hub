...
- [1. 介绍 LLM、RAG、Agent、Memory、Retrieval、KG 等相关技术的融合](#1-介绍-llmragagentmemoryretrievalkg-等相关技术的融合)
  - [1.1. coding skill 集合](#11-coding-skill-集合)
  - [1.2. skill.empjs.dev](#12-skillempjsdev)
  - [1.3. skill沙盘集合](#13-skill沙盘集合)
  - [1.4. ralv.ai  /  RVA.ai。](#14-ralvai----rvaai)
  - [1.5. agentic 训练](#15-agentic-训练)
  - [1.6. Manus context summary](#16-manus-context-summary)
  - [1.7. agent memory paper github collection](#17-agent-memory-paper-github-collection)
  - [1.8. agent skill](#18-agent-skill)
  - [1.9. 25年最后总结-大模型手把手及相关开源社区](#19-25年最后总结-大模型手把手及相关开源社区)
  - [1.10. Manus是一款在人工智能领域具有突破性意义的通用AI智能体产品，其“厉害”之处主要体现在以下几个方面：](#110-manus是一款在人工智能领域具有突破性意义的通用ai智能体产品其厉害之处主要体现在以下几个方面)
  - [1.11. DeepAnalyze：自主数据科学中的代理大型语言模型](#111-deepanalyze自主数据科学中的代理大型语言模型)
  - [1.12. LLM在游戏中应用的综述 https://arxiv.org/pdf/2402.18659](#112-llm在游戏中应用的综述-httpsarxivorgpdf240218659)
  - [1.13. “AgentGuide” from adongwanai](#113-agentguide-from-adongwanai)
  - [1.14. 智能体记忆的综述论文《Memory in the Age of AI Agents: A Survey》](#114-智能体记忆的综述论文memory-in-the-age-of-ai-agents-a-survey)
  - [1.15. 2025年11月13截止之前的memory 方案汇总对比](#115-2025年11月13截止之前的memory-方案汇总对比)
  - [1.16. obsidian 做个人 memory](#116-obsidian-做个人-memory)
      - [1.16.0.1. 支持哪些特殊语法？](#11601-支持哪些特殊语法)
      - [1.16.0.2. 如何形成知识图谱？](#11602-如何形成知识图谱)
      - [1.16.0.3. 具体例子说明](#11603-具体例子说明)
  - [1.17. 读论文+github 神器 deepwiki](#117-读论文github-神器-deepwiki)
  - [1.18. verl](#118-verl)
  - [1.19. pageindex](#119-pageindex)
  - [1.20. PostgreSQL == 多合一数据库：用插件替代专用数据库](#120-postgresql--多合一数据库用插件替代专用数据库)
    - [1.20.1. 官网](#1201-官网)
    - [1.20.2. 完整对应清单](#1202-完整对应清单)
    - [1.20.3. 关键插件详解（生产级选型）](#1203-关键插件详解生产级选型)
      - [1.20.3.1. 替代 InfluxDB（时序数据库）](#12031-替代-influxdb时序数据库)
      - [1.20.3.2. 替代 Milvus（向量数据库）](#12032-替代-milvus向量数据库)
      - [1.20.3.3. 替代 Neo4j（图数据库）+ pgRouting（地理路由）](#12033-替代-neo4j图数据库-pgrouting地理路由)
      - [1.20.3.4. 替代 Redis（缓存/高性能读写）](#12034-替代-redis缓存高性能读写)
      - [1.20.3.5. 替代 Elasticsearch（全文检索/搜索引擎）](#12035-替代-elasticsearch全文检索搜索引擎)
      - [1.20.3.6. 替代 MongoDB（文档数据库）](#12036-替代-mongodb文档数据库)
    - [1.20.4. 补充说明](#1204-补充说明)
  - [1.21. agent memory方向主要有2个：](#121-agent-memory方向主要有2个)
  - [1.22. 长记忆开源方案update](#122-长记忆开源方案update)
  - [1.23. Improving Language Agents through BREW](#123-improving-language-agents-through-brew)
  - [1.24. llm各种框架和论文，4000+⭐](#124-llm各种框架和论文4000)
  - [1.25. agent evolver](#125-agent-evolver)
  - [1.26. 微软 agent](#126-微软-agent)
  - [1.27. 谷歌新研究定义"充分上下文"：](#127-谷歌新研究定义充分上下文)
  - [1.28. EverMemOS](#128-evermemos)
  - [1.29. MCP 生态链接](#129-mcp-生态链接)
  - [1.30. 之后是2025年11月13之前汇总](#130-之后是2025年11月13之前汇总)
  - [1.31. 综述](#131-综述)
  - [1.32. context-labs / aella-data-explorer 1亿篇论文组成知识图谱KG](#132-context-labs--aella-data-explorer-1亿篇论文组成知识图谱kg)
  - [1.33. multi ai agent game](#133-multi-ai-agent-game)
  - [1.34. langchain 中间件](#134-langchain-中间件)
  - [1.35. todolist middleware](#135-todolist-middleware)
  - [1.36. 舆情分析](#136-舆情分析)
  - [1.37. LightMem：像人脑一样高效的记忆系统](#137-lightmem像人脑一样高效的记忆系统)
  - [1.38. llm训练](#138-llm训练)
  - [1.39. Prop RAG](#139-prop-rag)
  - [1.40. 基于多模态信息抽取的菜品知识图谱构建](#140-基于多模态信息抽取的菜品知识图谱构建)
  - [1.41. ragflow 已经支持 知识图谱](#141-ragflow-已经支持-知识图谱)
  - [1.42. flashrag](#142-flashrag)
  - [1.43. LightRAG](#143-lightrag)
  - [1.44. llm agent 综述](#144-llm-agent-综述)
  - [1.45. 谷歌 vs 微软 deepresearch](#145-谷歌-vs-微软-deepresearch)
  - [1.46. Reasoning with Sampling: Your Base Model is Smarter Than You Think](#146-reasoning-with-sampling-your-base-model-is-smarter-than-you-think)
  - [1.47. Agentic RAG新范式！天大\&小红书提出DecEx-RAG，剪枝搜索扩展提速6倍](#147-agentic-rag新范式天大小红书提出decex-rag剪枝搜索扩展提速6倍)
  - [1.48. 日报神器，记录你的一天 Dayflow](#148-日报神器记录你的一天-dayflow)
  - [1.49. 可信AI Agent相关论文(DPO)](#149-可信ai-agent相关论文dpo)
  - [1.50. Graph-Base Agent基于任务图的Agent框架](#150-graph-base-agent基于任务图的agent框架)
  - [1.51. A-Mem: Agentic Memory for LLM Agents](#151-a-mem-agentic-memory-for-llm-agents)
  - [1.52. logic rag](#152-logic-rag)
  - [1.53. LightMem](#153-lightmem)
  - [1.54. langchain graphrag](#154-langchain-graphrag)
  - [1.55. G-memory, Arcmemo, reasoning bank](#155-g-memory-arcmemo-reasoning-bank)
  - [1.56. embedding model 天梯](#156-embedding-model-天梯)
  - [1.57. MonkeyOCR](#157-monkeyocr)
  - [1.58. GitHub代码检索](#158-github代码检索)
  - [1.59. 视频转文字](#159-视频转文字)
  - [1.60. 音视频2文本](#160-音视频2文本)
  - [1.61. 爬虫数据采集圣器](#161-爬虫数据采集圣器)
  - [1.62. ai伴侣](#162-ai伴侣)
  - [1.63. metaGPT](#163-metagpt)
  - [1.64. unsloth](#164-unsloth)
  - [1.65. ai 知识库](#165-ai-知识库)
  - [1.66. 高质量rag](#166-高质量rag)
  - [1.67. ai混合搜索 meili](#167-ai混合搜索-meili)
  - [1.68. mem 推移学习，自我改进](#168-mem-推移学习自我改进)
  - [1.69. 腾讯 tree graphrag （2025年9月）](#169-腾讯-tree-graphrag-2025年9月)
  - [1.70. Graphiti vs GraphRAG 对比](#170-graphiti-vs-graphrag-对比)
  - [1.71. 自己用milvus+neo4j实现graphrag](#171-自己用milvusneo4j实现graphrag)
  - [1.72. 微软 graphRAG](#172-微软-graphrag)
  - [1.73. awesome-ai-memory 汇聚memory相关项目](#173-awesome-ai-memory-汇聚memory相关项目)
  - [1.74. es agent](#174-es-agent)
  - [1.75. MINE Context](#175-mine-context)
  - [1.76. 拼好rag](#176-拼好rag)
  - [1.77. mem0 2025年9月27日持续更新github](#177-mem0-2025年9月27日持续更新github)
  - [1.78. 蚂蚁 KAG](#178-蚂蚁-kag)
  - [1.79. 如何基于语义相似性分割文本](#179-如何基于语义相似性分割文本)
  - [1.80. 各种向量数据库对比](#180-各种向量数据库对比)
  - [1.81. 基于hnswlib的向量索引(2年前更新)](#181-基于hnswlib的向量索引2年前更新)
  - [1.82. stream vq 生成式召回](#182-stream-vq-生成式召回)
  - [1.83. ai学术搜索](#183-ai学术搜索)
  - [1.84. nlp etc.](#184-nlp-etc)
  - [1.85. 知识图谱 - 北京大学大数据分析与应用技术国家工程实验室成员，  包括各种知识图谱抽取+检索，neo4j+MongoDB等](#185-知识图谱---北京大学大数据分析与应用技术国家工程实验室成员--包括各种知识图谱抽取检索neo4jmongodb等)
  - [1.86. 唐国梁Tommy : rag + llm + es](#186-唐国梁tommy--rag--llm--es)
  - [1.87. 长文本提取结构化信息](#187-长文本提取结构化信息)
  - [1.88. 非结构化转结构化，用于微调等](#188-非结构化转结构化用于微调等)
  - [1.89. MongoDB + ES 向量存储 + 文本分割器SpacyTextSplitter （24年6月11日）](#189-mongodb--es-向量存储--文本分割器spacytextsplitter-24年6月11日)
  - [1.90. ai coding](#190-ai-coding)
...
## 1.7. agent memory paper github collection
...
## 1.10. Manus是一款在人工智能领域具有突破性意义的通用AI智能体产品，其“厉害”之处主要体现在以下几个方面：
...
## 1.11. DeepAnalyze：自主数据科学中的代理大型语言模型
[DeepAnalyze](https://github.com/DataClasse/deepanalyze)

## 1.12. LLM在游戏中应用的综述 https://arxiv.org/pdf/2402.18659
...
## 1.13. “AgentGuide” from adongwanai
...
## 1.14. 智能体记忆的综述论文《Memory in the Age of AI Agents: A Survey》
...
## 1.15. 2025年11月13截止之前的memory 方案汇总对比
- **AI Memory 项目完整对照表**
- 一、🔥开源记忆框架推荐
  - 1 MemOS
    - 团队：记忆张量 + 上海交大等
...
## 1.20. PostgreSQL == 多合一数据库：用插件替代专用数据库
### 1.20.1. 官网
...
#### 1.20.3.5. 替代 Elasticsearch（全文检索/搜索引擎）
...
## 1.23. Improving Language Agents through BREW
...
## 1.30. 之后是2025年11月13之前汇总

## 1.31. 综述
《Agentic Retrieval-Augmented Generation: A Survey on Agentic RAG》

## 1.32. context-labs / aella-data-explorer 1亿篇论文组成知识图谱KG
...
## 1.45. 谷歌 vs 微软 deepresearch
 https://mp.weixin.qq.com/s/e_1dGQRLfc_fGAZrQEsLVw
## 1.46. Reasoning with Sampling: Your Base Model is Smarter Than You Think
...
## 1.47. Agentic RAG新范式！天大&小红书提出DecEx-RAG，剪枝搜索扩展提速6倍

## 1.48. 日报神器，记录你的一天 Dayflow
项目地址是
 https://github.com/JerryZLiu/Dayflow

，展示了这个开源日报工具

##  1.49. 可信AI Agent相关论文(DPO)
...
## 1.50. Graph-Base Agent基于任务图的Agent框架
...
## 1.51. A-Mem: Agentic Memory for LLM Agents
...
## 1.55. G-memory, Arcmemo, reasoning bank
三篇论文


## 1.56. embedding model 天梯
...
## 1.69. 腾讯 tree graphrag （2025年9月）
https://mp.weixin.qq.com/s/Ddf3rpdJP8P_L5yaPnBFBA

## 1.70. Graphiti vs GraphRAG 对比
...
## 1.71. 自己用milvus+neo4j实现graphrag
...
## 1.73. awesome-ai-memory 汇聚memory相关项目
...
## 1.77. mem0 2025年9月27日持续更新github
基于graph+rag的mem0
...
## 1.81. 基于hnswlib的向量索引(2年前更新)
https://github.com/nmslib/hnswlib

## 1.82. stream vq 生成式召回
...
## 1.85. 知识图谱 - 北京大学大数据分析与应用技术国家工程实验室成员，  包括各种知识图谱抽取+检索，neo4j+MongoDB等
https://liuhuanyong.github.io/

## 1.86. 唐国梁Tommy : rag + llm + es
...
## 1.89. MongoDB + ES 向量存储 + 文本分割器SpacyTextSplitter （24年6月11日）
